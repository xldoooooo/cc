...
(defsystem "quadrotor_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "mpc_ref_point" :depends-on ("_package_mpc_ref_point"))
    (:file "_package_mpc_ref_point" :depends-on ("_package"))
    (:file "mpc_ref_traj" :depends-on ("_package_mpc_ref_traj"))
    (:file "_package_mpc_ref_traj" :depends-on ("_package"))
  ))