#ifndef __QUADROTOR_SIMULATOR_MYMODEL_H__
#define __QUADROTOR_SIMULATOR_MYMODEL_H__
...
public:
  ...
  const myModel::State& getState(void) const;

  void setState(const myModel::State& state);
  ...
  void operator()(const myModel::InternalState& x,
