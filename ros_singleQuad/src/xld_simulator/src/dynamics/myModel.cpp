...
// 获取仿真模型的dxdt
void myModel::operator()(const myModel::InternalState& x,
                      myModel::InternalState& dxdt, const double /* t */)
{
  // 定义全状态量并赋值
  State cur_state;
  for (int i = 0; i < 3; i++)
...
// 设置电机转速输入
void myModel::setInput(double u1, double u2, double u3, double u4)
{
  input_(0) = u1;
  input_(1) = u2;
  input_(2) = u3;
...
// 获取模型状态
// 函数名后加const：表示无法修改传递给它的任何参数的值
const myModel::State& myModel::getState(void) const
{
  return state_;
}

// 设置模型状态
void myModel::setState(const myModel::State& state)
{
  state_.x         = state.x;
  state_.v         = state.v;
  state_.R         = state.R;
...
// 设置无人机的位置
void myModel::setStatePos(const Eigen::Vector3d& Pos)
{
  state_.x = Pos;
...
// 获取无人机的质量
double myModel::getMass(void) const
{
  return mass_;
}

// 设置无人机的质量
void myModel::setMass(double mass)
{
  mass_ = mass;
}

// 获取无人机的引力常数
double myModel::getGravity(void) const
{
  return g_;
}

// 设置无人机的引力常数
void myModel::setGravity(double g)
{
  g_ = g;
}

// 获取无人机的惯量矩阵
const Eigen::Matrix3d& myModel::getInertia(void) const
{
  return J_;
}

// 设置无人机的惯量矩阵
void myModel::setInertia(const Eigen::Matrix3d& inertia)
{
...
// 获取无人机的机臂长度
double myModel::getArmLength(void) const
{
  return arm_length_;
}

// 设置无人机的机臂长度
void myModel::setArmLength(double d)
{
  if (d <= 0)
  {
...
// 获取无人机的桨叶半径
double myModel::getPropRadius(void) const
{
  return prop_radius_;
}

// 设置无人机的桨叶半径
void myModel::setPropRadius(double r)
{
  if (r <= 0)
  {
...
// 获取螺旋桨升力系数
double myModel::getPropellerThrustCoefficient(void) const
{
  return kf_;
}

// 设置螺旋桨升力系数
void myModel::setPropellerThrustCoefficient(double kf)
{
  if (kf <= 0)
  {
...
// 获取螺旋桨力矩系数
double myModel::getPropellerMomentCoefficient(void) const
{
  return km_;
}

// 设置螺旋桨力矩系数
void myModel::setPropellerMomentCoefficient(double km)
{
  if (km <= 0)
  {
...
// 获取电机时间常数
double myModel::getMotorTimeConstant(void) const
{
  return motor_time_constant_;
}

// 设置电机时间常数
void myModel::setMotorTimeConstant(double k)
{
  if (k <= 0)
  {
...
// 获取无人机外力
const Eigen::Vector3d& myModel::getExternalForce(void) const
{
  return external_force_;
}

// 设置无人机外力
void myModel::setExternalForce(const Eigen::Vector3d& force)
{
  external_force_ = force;
}

// 获取无人机外力矩
const Eigen::Vector3d& myModel::getExternalMoment(void) const
{
  return external_moment_;
}

// 设置无人机外力矩
void myModel::setExternalMoment(const Eigen::Vector3d& moment)
{
  external_moment_ = moment;
}

// 获取最大桨叶转速
double myModel::getMaxRPM(void) const
{
  return max_rpm_;
}

// 设置最大桨叶转速
void myModel::setMaxRPM(double max_rpm)
{
  if (max_rpm <= 0)
  {
...
// 获取最小桨叶转速
double myModel::getMinRPM(void) const
{
  return min_rpm_;
}

// 设置最小桨叶转速
void myModel::setMinRPM(double min_rpm)
{
  if (min_rpm < 0)
  {
...
// 更新模型的内部状态
void myModel::updateInternalState(void)
{
  for (int i = 0; i < 3; i++)
  {
...
// 获取无人机加速度信息
Eigen::Vector3d myModel::getAcc() const
{
  return acc_;
}
