...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /home/hyy/Xld_NMPC_Sim/src/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /home/hyy/Xld_NMPC_Sim/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /home/hyy/Xld_NMPC_Sim/install)
...
if(NOT "/home/hyy/Xld_NMPC_Sim/devel/include " STREQUAL " ")
  set(multi_map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/hyy/Xld_NMPC_Sim/devel/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/hyy/Xld_NMPC_Sim/src/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
