...
class SO3Command(genpy.Message):
  _md5sum = "741c893b2aab9fa19593c1edcd8086c4"
...
"""
  __slots__ = ['header','force','omega','orientation','kR','kOm','aux']
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Quaternion','float64[3]','float64[3]','quadrotor_msgs/AuxCommand']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,force,omega,orientation,kR,kOm,aux
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_10d().pack(_x.force.x, _x.force.y, _x.force.z, _x.omega.x, _x.omega.y, _x.omega.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.force.x, _x.force.y, _x.force.z, _x.omega.x, _x.omega.y, _x.omega.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w,) = _get_struct_10d().unpack(str[start:end])
      start = end
      end += 24
